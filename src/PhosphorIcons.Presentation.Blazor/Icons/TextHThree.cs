...
/// <summary>Phosphor <c>text-h-three</c> icon.</summary>
public sealed class TextHThree : PhosphorIconBase
{
    ...
    public static IconDefinition Definition { get; } = new(
        ...
        Paths: new IconPaths(
            ...
            Duotone: new IconDuotone(
                Background: """<path d="M240,64V200a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V56H232A8,8,0,0,1,240,64Z" opacity="0.2"/>""",
                Foreground: """<path d="M152,56V176a8,8,0,0,1-16,0V124H48v52a8,8,0,0,1-16,0V56a8,8,0,0,1,16,0v52h88V56a8,8,0,0,1,16,0Zm73.52,90.63,21-30A8,8,0,0,0,240,104H192a8,8,0,0,0,0,16h32.63l-19.18,27.41A8,8,0,0,0,212,160a20,20,0,1,1-14.29,34,8,8,0,1,0-11.42,11.19A36,36,0,0,0,248,180,36.07,36.07,0,0,0,225.52,146.63Z"/>"""
            )
        )
    );
