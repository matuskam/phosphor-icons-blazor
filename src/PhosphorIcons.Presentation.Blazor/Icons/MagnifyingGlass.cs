...
/// <summary>Phosphor <c>magnifying-glass</c> icon.</summary>
public sealed class MagnifyingGlass : PhosphorIconBase
{
    ...
    public static IconDefinition Definition { get; } = new(
        ...
        Paths: new IconPaths(
            ...
            Duotone: new IconDuotone(
                ...
                Foreground: """<path d="M229.66,218.34,179.6,168.28a88.21,88.21,0,1,0-11.32,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z"/>"""
            )
        )
    );
