...
/// <summary>Phosphor <c>minus</c> icon.</summary>
public sealed class Minus : PhosphorIconBase
{
    ...
    public static IconDefinition Definition { get; } = new(
        ...
        Paths: new IconPaths(
            ...
            Duotone: new IconDuotone(
                ...
                Foreground: """<path d="M224,128a8,8,0,0,1-8,8H40a8,8,0,0,1,0-16H216A8,8,0,0,1,224,128Z"/>"""
            )
        )
    );
