...
/// <summary>Phosphor <c>shield-checkered</c> icon.</summary>
public sealed class ShieldCheckered : PhosphorIconBase
{
    ...
    public static IconDefinition Definition { get; } = new(
        ...
        Paths: new IconPaths(
            ...
            Light: """<path d="M208,42H48A14,14,0,0,0,34,56v58.77c0,88.25,74.68,117.52,89.65,122.49a13.5,13.5,0,0,0,8.7,0c15-5,89.65-34.24,89.65-122.49V56A14,14,0,0,0,208,42Zm2,14v58.77c0,2.46-.07,4.86-.19,7.21H134V54h74A2,2,0,0,1,210,56ZM46,56a2,2,0,0,1,2-2h74v68H46.19c-.12-2.35-.19-4.75-.19-7.21Zm1.4,78H122v89.9C103.17,216.44,56.08,192.18,47.4,134ZM134,223.9V134h74.6C199.92,192.17,152.83,216.44,134,223.9Z"/>""",
            ...
            Fill: """<path d="M208,40H48A16,16,0,0,0,32,56v58.77c0,89.62,75.82,119.34,91,124.38a15.44,15.44,0,0,0,10,0c15.2-5.05,91-34.77,91-124.39V56A16,16,0,0,0,208,40ZM48.66,128H128V56h80v58.77a130.51,130.51,0,0,1-.66,13.21H128v96h0C115.26,219.73,55.59,196.26,48.66,128Z"/>""",
            Duotone: new IconDuotone(
                Background: """<path d="M215.39,128c-7,73.93-71.47,99.12-84.93,103.59A7.93,7.93,0,0,1,128,232V128h87.39ZM128,48H48a8,8,0,0,0-8,8v58.77q0,6.85.61,13.21H128Z" opacity="0.2"/>""",
                Foreground: """<path d="M208,40H48A16,16,0,0,0,32,56v58.77c0,89.62,75.82,119.34,91,124.38a15.44,15.44,0,0,0,10,0c15.2-5.05,91-34.77,91-124.39V56A16,16,0,0,0,208,40Zm0,74.79c0,1.77,0,3.5-.11,5.21H136V56h72ZM48,56h72v64H48.11c-.07-1.71-.11-3.44-.11-5.21Zm1.74,80H120v84.92C100.32,212.56,58.73,188.92,49.74,136ZM136,220.91V136h70.26C197.27,188.89,155.72,212.54,136,220.91Z"/>"""
            )
        )
    );
