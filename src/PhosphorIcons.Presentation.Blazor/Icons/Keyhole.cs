...
/// <summary>Phosphor <c>keyhole</c> icon.</summary>
public sealed class Keyhole : PhosphorIconBase
{
    ...
    public static IconDefinition Definition { get; } = new(
        ...
        Paths: new IconPaths(
            ...
            Fill: """<path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm22.58-80,12.56,31.55A12,12,0,0,1,152,184H104a12,12,0,0,1-11.14-16.44L105.42,136a36,36,0,1,1,45.16,0Z"/>""",
            Duotone: new IconDuotone(
                Background: """<path d="M156,176H100a4,4,0,0,1-3.71-5.48l13-32.58a32,32,0,1,1,37.48,0l13,32.58A4,4,0,0,1,156,176Z" opacity="0.2"/>""",
